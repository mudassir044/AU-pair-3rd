...
import { useAuthStore } from "@/lib/utils"; // Assuming you have an auth store
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-blue-50 dark:from-primary-950 dark:via-background dark:to-blue-950 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <Card className="shadow-2xl border-0">
          ...
          <CardContent>
            {error && (
              <div className="bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg p-4 text-red-700 dark:text-red-300 text-center mb-6">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-primary to-blue-600 hover:from-primary-600 hover:to-blue-700 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                disabled={loading}
              >
